...
project.addScripts({
  ...
  "kube:apply": "npm run compile && npm run synth && kubectl apply -f dist/",
  ...
  "kube:forward-kibana": "kubectl port-forward service/kibana-kb-http 5601",
  ...
  "elastic:bulk": "curl -u \"elastic:$(kubectl get secret elasticsearch-es-elastic-user -o go-template='{{.data.elastic | base64decode}}')\" -H 'Content-Type:application/x-ndjson' -XPOST -k http://localhost:9200/national-parks/_bulk --data-binary @data/national-es-bulk-index.json",
